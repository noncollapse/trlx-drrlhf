...
default_config = TRLConfig(
    train=TrainConfig(
        ...
        trainer="AccelerateDRTrainer",
        checkpoint_dir="checkpoints/dr_hh",
    ),
...
if config_name == "125M":
    ...
    default_config.train.checkpoint_dir = "checkpoints/dr_hh_125M"
    ...
    default_config.train.checkpoint_dir = "checkpoints/dr_hh_1B"
    ...
    default_config.train.checkpoint_dir = "checkpoints/dr_hh_6B"
    ...
    default_config.train.checkpoint_dir = "checkpoints/dr_hh_20B"
